...
import com.mutwakil.lsp.kotlin.KotlinLspService;
...
import kotlin.Unit;
import dev.mutwakil.kotlinide.R;
...
public class LspTestJavaActivity extends AppCompatActivity {
  ...
  private void setEditorText() throws IOException {
    var file = new File(getExternalCacheDir(), "testProject/sample.kt");
  ...
  private void connectToLanguageServer() throws IOException, InterruptedException {
    ...
    var intent = new Intent(this, KotlinLspService.class);
  ...
  protected void onDestroy() {
    ...
    try {
      ...
      stopService(new Intent(LspTestJavaActivity.this, KotlinLspService.class));
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
  }
  ...
  private void ensureTextmateTheme() throws Exception {
    ...
    var path = "textmate/QuietLight.tmTheme";
